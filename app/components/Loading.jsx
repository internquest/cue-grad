...
const Loading = () => {
    ...
    return (
        <div style={{ opacity: loadfull && 0, transitionDuration: loadfull && '1s' }} className='fixed top-0 bottom-0 right-0 left-0 bg-[#000815] z-[11] flex transition-opacity duration-[2s] ease-[cubic-bezier(0.42,0,0.33,1)] '>
