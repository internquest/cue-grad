...
const MobileIndividual = ({ desc, title, indexed, activedesc }) => {
    ...
    // Memoize the initial and animate props
    const motionProps = useMemo(() => {
        return {
            initial: { y: '-40px' },
            animate: open ? { y: 0, transitionDuration: '.3s', transitionTimingFunction: 'linear' } : {}
        }
    }, [open])
                    ...
                    <div className='flex flex-none items-center self-stretch  h-auto justify-center relative w-min'>
                        <div className='h-[24px] relative w-[24px] flex-none'>
                            {!open ?
                                ...
                                :
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="var(--token-cfebd3db-8ed9-4e26-8ab4-46ccd2d53ef2, rgb(1, 88, 64))" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ width: "100%", height: "100%" }}><line x1="5" y1="12" x2="19" y2="12"></line></svg>
                            }
                        </div>
                    </div>
                </div>
