            ...
            <Revealcompo css={'flex flex-col bg-[#cfff92] rounded-[20px] flex-grow-[1] flex-shrink-0 basis-0 tml:h-auto gap-0 tml:min-h-0 min-h-[600px] justify-start  items-center bmL4k:max-w-[1312px] max-w-[1640px] p-0 relative w-full'}>
                <div className=' bmLLL:p-[64px] bmL4k:p-[64px] tml:p-3 p-16 bmLLL:pt-0 bmL4k:pt-0 pt-0 tml:w-full bmLLL:w-full w-[85%] flex flex-col flex-none items-center justify-start gap-6 h-min relative'>
                    <div className='flex justify-start flex-col flex-shrink-0 mt-20 flex-none h-auto relative whitespace-pre-wrap w-full'>
                        <p className={`${archivo.className} font-semibold text-[#015840] text-[20px] tracking-[-.5px] leading-[2rem] text-center tml:p-2  m-0 p-0`}>About Cue</p>
                    </div>
                    <div className='flex-none h-auto relative flex justify-center mt-2  whitespace-pre-wrap w-full'>
                        <h2 className={` ${archivo.className} font-medium  text-[#015840]/[.85] text-[1.65rem]   tml:w-full max-w-[650px]   tracking-[-.5px] leading-[1.7] md:leading-[2]  text-center `}>
                ...
                <div className={`bmLLL:h-auto   flex-none relative w-full   ${archivo.className} `}>
                    <div className='flex justify-center items-end'>
                        ...
                        <div className='max-w-[276px] relative tml:hidden rotate-[-24deg] mb-[35px]  flex-grow rounded-[75px] h-[100px]  bg-[#FEAE67]'>
                            <p className='font-bold text-[#32200C] text-[42px] leading-[2.2] text-center tracking-[-.5px]'>assistant</p>
                        ...
                        <div className='max-w-[276px] relative tml:hidden ml-[-39px]  flex-grow rounded-[75px] h-[100px]  bg-[#301F3F]'>
                            <p className='font-bold text-[#977DE0] text-[42px] leading-[2.2] text-center tracking-[-.5px]'>on-campus</p>
                            {/* <div className=' relative flex-grow tml:hidden max-w-[170px] h-[70px] lg:max-w-[293px]  lg:ml-2 lg:h-[100px]'> */}

                            {/* <Image src={oncampus} alt='' fill={true} /> */}
                        </div>
                        <div className='    py-8 relative tml:hidden  rounded-[75px] -mb-12 ml-3  bg-[#005840]'>
                            <p className='font-bold text-[#CFFD92] [writing-mode:vertical-rl] [text-orientation:upright] text-[42px] leading-[2.2] text-center tracking-[-.5px]'>drives</p>
