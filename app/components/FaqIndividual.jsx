            ...
            <div className='flex flex-none tml:gap-4 gap-6 h-min justify-center items-center w-full p-0'>
                <div className='flex tml:flex-col justify-center tml:items-start items-center flex-grow-[1] flex-shrink-0 basis-0 tml:gap-2 gap-12 h-min p-0'>
                    <div className='outline-none flex-none h-auto relative tml:w-min w-[42px]'>
                        <h3 className={`${epilogue.className} ${!open ? "text-[#987de1]" : "text-[#015840]"} font-normal tml:text-[1.15rem]  text-[32px]  tracking-[-.5px] tml:leading-[2.1] leading-[1.2rem] text-center `}>0{indexed + 1}</h3>
                    </div>
