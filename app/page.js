      ...
      <div className="  flex flex-col bg-white min-h-screen w-auto h-min justify-start p-0 relative ">
        <div className="   overflow-hidden flex relative w-full btl:pt-[80px] btl:px-6 btl:pb-6 bmLLL:pt-[116px] bmLLL:px-16 bmLLL:pb-16 tml:pt-[116px] tml:px-2 tml:pb-4 pt-[126px] px-16 pb-16 flex-none h-min justify-center flex-col items-center">
          ...
          <Revealcompo css={"bg-[#CFFF92]  bmL4k:max-w-[1312px]  max-w-[1640px] flex tml:items-start items-center tml:justify-start tml:rounded-bl-[0px] tml:rounded-br-[0px] rounded-[30px]  flex-grow flex-shrink-0 basis-0 flex-col h-auto   px-2 w-full "}>
            ...
            <h2 className={`w-full px-2  md:hidden  text-left mt-16 ${epilogue.className} font-medium text-[2rem]  leading-[1.7] tracking-[.005em] text-center`}>
        ...
        <div className="   overflow-hidden flex relative w-full tml:px-2 tml:pb-4  btl:px-6 btl:pb-6 bmLLL:px-16 bmLLL:pb-16 pb-10  px-16 flex-none h-min justify-center flex-col items-center">
          ...
          <Revealcompo css={"bg-[#FDF3EA] bmLLL:max-w-[1180px] bmL4k:max-w-[1312px] max-w-[1640px] flex items-center tml:p-3 p-16 rounded-[30px]  text-[#F9576E] flex-grow flex-shrink-0 basis-0 flex-col pt-2 px-2 w-full"}>
            ...
            <h1 className={`${epilogue.className} font-medium tml:text-[1.3rem] text-[2rem] md:text-[3.25rem] leading-[2] tracking-normal`}>Meet CueGrad</h1>
        ...
        <div className="bmLLL:pt-0 bmLLL:px-16 bmLLL:pb-16 flex items-center flex-none w-full h-min justify-center overflow-hidden relative btl:pt-0 btl:px-6 btl:pb-6 btl:py-0 tml:p-4 tml:px-2 py-16 px-0">
          <div className="items-center rounded-[30px]  flex-grow flex-shrink-0 basis-0 flex-col h-min max-w-[1640px] overflow-hidden relative bmL4k:max-w-[1312px] ">
            <div className="bg-[#977DE0] rounded-[30px] tml:pt-12 tml:px-4 tml:pb-6 tml:gap-11 pt-16 px-11 pb-11 w-full flex  flex-col gap-16 h-min  items-center justify-start overflow-hidden ">
              <h2 className={`${epilogue.className}  font-medium tml:text-start text-center text-[1.5rem] lg:text-[2rem] mt-3 leading-[1.8] text-white tracking-normal`}>Here’s what students have to say about Cuegrad</h2>
          ...
          <div className="flex flex-grow flex-shrink-0 basis-0 flex-col h-min justify-start max-w-[1640px] bmL4k:max-w-[1312px] overflow-hidden p-0 relative ">
            ...
            <div className="flex flex-col flex-none w-full relative items-center justify-start tml:gap-10 gap-[64px] h-min p-0">
              ...
              <Revealcompo css={"flex flex-col items-center flex-none p-0 w-full gap-3 h-min justify-start "} >
                <h1 className={`font-medium tml:text-start text-[1.7rem] md:text-[2.25rem] mx-auto text-center text-black leading-[1.7] tracking-normal max-w-[619px] ${epilogue.className}`}>On-Campus Placements Assistant to
                  help you get placed</h1>
                <p className={`${epilogue.className} font-normal  text-center text-[1rem] md:text-[1.25rem] leading-[2] tracking-normal tml:text-start max-w-[532px] text-[#2C2C2C]/[.9]`}>CueGrad is your AI-powered co-pilot, guiding you through
              ...
              <div className="flex flex-col items-center flex-none tml:gap-10 gap-[64px] h-min justify-start p-0 relative w-full mx-auto ">
                ...
                <Revealcompo css={"flex  flex-row tml:flex-col tml:pl-0 pl-4 bmLLL:pl-16 tml:gap-5 gap-5 md:gap-24 p-0 w-full h-min relative flex-none justify-center  items-center"}>
                  <div className={`${epilogue.className} flex tml:flex-none tml:w-full items-start flex-col flex-grow flex-shrink-0 basis-0 gap-5 h-min justify-start p-0 relative `}>
                ...
                <Revealcompo css={"flex flex-row  tml:flex-col tml:gap-5 gap-5 md:gap-24 p-0  w-full h-min relative flex-none justify-center  items-center"}>
                  ...
                  <div className={`${epilogue.className} tml:order-0 text-[#2C2C2C]  flex items-start flex-grow flex-shrink-0 tml:flex-none tml:w-full basis-0 flex-col justify-start   gap-2`}>
                ...
                <Revealcompo css={"flex flex-row  tml:flex-col tml:pl-0 pl-4 tml:gap-5 bmLLL:pl-16 gap-5 md:gap-24 p-0  w-full h-min relative flex-none justify-center  items-center"}>
                  <div className={`${epilogue.className} tml:flex-none tml:w-full text-[#2C2C2C]  flex items-start flex-grow flex-shrink-0 basis-0 flex-col justify-start   gap-2 `}>
              ...
              <div className="flex flex-col flex-none items-center justify-start gap-2 h-min w-full p-0 relative">
                <div className="flex items-center justify-center bg-[#cfff92] rounded-[100px] h-min py-2 px-4 relative w-min">
                  <div className="flex justify-start flex-col flex-shrink-0 flex-none relative whitespace-pre w-auto h-auto">
                    <p className={`${epilogue.className} text-[1rem] font-normal tracking-normal leading[1.3] text-[#015840]`}>New feature</p>
                  </div>
                </div>
                <div className={`flex flex-col bmLLL:w-[60%]  flex-none items-center justify-start gap-3 h-min relative w-full p-0 `}>
                  <div className="flex  flex-none w-full whitespace-pre-wrap h-auto relative ">
                    <h2 className={`tml:text-[2.375rem] btl:text-[2.5rem] bmLLL:text-[2.75rem] bmL4k:text-[2.75rem] text-[3.5rem] w-full ${epilogue.className} bmLLL:font-normal tracking-[-.02em] leading-[1.2] text-center text-white  `}>
                  ...
                  <div className="`bmLLL:text-[2.75rem] bmLLL:font-normal tracking-[-.02em] leading-[1.2] text-white ">
                    <p className={`text-white ${epilogue.className} text-[1.3rem] font-normal tracking-[-.02em] leading-[1.5] text-center`}>Get the helpfulness of a human coach without the $500 price tag.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex tml:flex-col btl:flex-col  flex-none gap-6 h-min justify-start p-0 relative w-full">
                ...
                <div className="flex tml:flex-none tml:w-full flex-col btl:flex-none btl:w-full flex-grow flex-shrink-0 basis-0 h-min items-start justify-start overflow-hidden relative p-0 gap-5 lg:gap-6">
                  ...
                  <Revealcompo css={"bg-[#CFFF92] border-black border-4 rounded-[20px] flex flex-col justify-center items-start p-8 gap-6  h-min"}>
                    <h2 className={`${epilogue.className} text-[#2C2C2C]/[.8] font-bold text-[1.125rem] lg:text-2xl leading-[1.9] tracking-[.005em]`}>AI-Driven Conversation Prompts</h2>
                  ...
                  <Revealcompo css={"bg-[#CFFF92] border-black border-4 rounded-[20px] flex flex-col justify-start items-start p-8 gap-6  h-min"}>
                    <h2 className={`${epilogue.className} text-[#2C2C2C]/[.8] font-bold text-[1.125rem] lg:text-2xl leading-[1.9] tracking-[.005em]`}>Placement Season Stress Manager</h2>
                ...
                <div className="flex tml:flex-none tml:w-full flex-col btl:flex-none btl:w-full flex-grow flex-shrink-0 basis-0 h-min items-center xl:-mb-10  justify-end  overflow-hidden relative p-0 gap-5 lg:gap-6">
                  ...
                  <Revealcompo css={"bg-[#CFFF92] border-black border-4 rounded-[20px] flex flex-col justify-start items-start  p-8 gap-6  h-min"}>
                    ...
                    <h2 className={`${epilogue.className} text-[#2C2C2C]/[.8] font-bold text-[1.125rem] lg:text-2xl leading-[1.9] tracking-[.005em]`}>Post-Drive Reflection Tool</h2>
                  ...
                  <Revealcompo css={"bg-[#CFFF92] border-black border-4 rounded-[20px] flex flex-col justify-start items-start  p-8 gap-6  h-min"}>
                    ...
                    <h2 className={`${epilogue.className}  text-[#2C2C2C]/[.8] font-bold text-[1.125rem] lg:text-2xl leading-[1.9] tracking-[.005em]`}>Interview Wardrobe Advisor</h2>
        ...
        <div className=" flex items-center flex-none h-min justify-center overflow-hidden btl:pt-0 btl:px-6 btl:pb-6 bmLLL:pt-0 tml:pt-16 tml:px-2 tml:pb-4 bmLLL:px-16 bmLLL:pb-16 py-16 px-0 relative w-full">
          ...
          <Revealcompo css={"bmLLL:max-w-[1180px] bmL4k:max-w-[1312px]  max-w-[1640px] flex items-center rounded-[30px] flex-grow flex-shrink-0 basis-0 flex-col justify-start overflow-hidden p-0 relative "}>
            <div className="bg-[#FFAE67] text-[#015840]  rounded-[30px]  items-center flex flex-col h-min justify-center  btl:pt-[60px] xl:pt-[100px] tml:p-6 tml:pb-0 btl:px-[150px] px-[209px] relative w-full flex-none ">
              <h2 className={`${epilogue.className}   text-center mx-auto font-normal text-[1.5rem] md:text-[2rem] leading-[1.9] tracking-[.01em] `}>Take control of your placement journey with</h2>

              <h1 className={`max-w-[594px] ${epilogue.className} font-extrabold tml:text-[6rem] mb-[-65px] text-[13rem] tml:text-start text-center xl:text-[18.75rem] tracking-[.01em] mx-auto leading-[1]`}>CUE</h1>
            </div>
          </Revealcompo>
